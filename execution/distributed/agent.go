...
func (c *AgentController) Wait(eventId string) func() error {
	c.logger.Debugf("Wait(%s)", eventId)
...
func (c *AgentController) Signal(eventId string) error {
	c.logger.Debugf("Signal(%s)", eventId)
