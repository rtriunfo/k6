...
func (x *RegisterResponse) GetTests() []*Test {
	if x != nil {
		return x.Tests
	}
	return nil
...
type Test struct {
	...
	Archive []byte `protobuf:"bytes,1,opt,name=archive,proto3" json:"archive,omitempty"` // TODO: send this with a `stream` of bytes chunks
...
func (x *MetricsDumpResponse) Reset() {
	*x = MetricsDumpResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_distributed_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MetricsDumpResponse) Descriptor() ([]byte, []int) {
	return file_distributed_proto_rawDescGZIP(), []int{8}
}
...
var file_distributed_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x74, 0x22, 0x5b, 0x0a, 0x10, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x52,
	...
	,
	...
	,
	...
	0x65, 0x22, 0x00, 0x28, 0x01, 0x30, 0x01, 0x12, 0x4b, 0x0a, 0x0b, 0x53, 0x65, 0x6e, 0x64, 0x4d,
	0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x12, 0x18, 0x2e, 0x64, 0x69, 0x73, 0x74, 0x72, 0x69, 0x62,
	0x75, 0x74, 0x65, 0x64, 0x2e, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x44, 0x75, 0x6d, 0x70,
	0x1a, 0x20, 0x2e, 0x64, 0x69, 0x73, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x64, 0x2e, 0x4d,
	0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x44, 0x75, 0x6d, 0x70, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x22, 0x00, 0x42, 0x23, 0x5a, 0x21, 0x67, 0x6f, 0x2e, 0x6b, 0x36, 0x2e, 0x69, 0x6f,
	0x2f, 0x6b, 0x36, 0x2f, 0x65, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x2f, 0x64, 0x69,
...
var file_distributed_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_distributed_proto_goTypes = []interface{}{
	...
	(*Test)(nil),                // 2: distributed.Test
	(*AgentMessage)(nil),        // 3: distributed.AgentMessage
	(*ControllerMessage)(nil),   // 4: distributed.ControllerMessage
	(*DataPacket)(nil),          // 5: distributed.DataPacket
	(*MetricsDump)(nil),         // 6: distributed.MetricsDump
	(*MetricDump)(nil),          // 7: distributed.MetricDump
	(*MetricsDumpResponse)(nil), // 8: distributed.MetricsDumpResponse
}
var file_distributed_proto_depIdxs = []int32{
	2, // 0: distributed.RegisterResponse.tests:type_name -> distributed.Test
	5, // 1: distributed.AgentMessage.createdData:type_name -> distributed.DataPacket
	5, // 2: distributed.ControllerMessage.dataWithID:type_name -> distributed.DataPacket
	7, // 3: distributed.MetricsDump.metrics:type_name -> distributed.MetricDump
	0, // 4: distributed.DistributedTest.Register:input_type -> distributed.RegisterRequest
	3, // 5: distributed.DistributedTest.CommandAndControl:input_type -> distributed.AgentMessage
	6, // 6: distributed.DistributedTest.SendMetrics:input_type -> distributed.MetricsDump
	1, // 7: distributed.DistributedTest.Register:output_type -> distributed.RegisterResponse
	4, // 8: distributed.DistributedTest.CommandAndControl:output_type -> distributed.ControllerMessage
	8, // 9: distributed.DistributedTest.SendMetrics:output_type -> distributed.MetricsDumpResponse
...
func file_distributed_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_distributed_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
	...
	file_distributed_proto_msgTypes[4].OneofWrappers = []interface{}{
